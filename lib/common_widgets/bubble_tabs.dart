...
class BubbleTabBar extends StatefulWidget implements PreferredSizeWidget {
  ...
  const BubbleTabBar(
      {Key key, @required this.tabs, this.isScrollable = true, this.controller})
      : assert(tabs != null),
        super(key: key);
...
class _BubbleTabBarState extends State<BubbleTabBar> {
  ...
  Widget build(BuildContext context) {
    ...
    return TabBar(
      ...
      labelColor: tabsLength != 1 ? Colors.blue : Colors.blue[800],
      unselectedLabelColor: tabsLength != 1 ? Colors.white : null,
